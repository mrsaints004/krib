...
export default function MessagesListPage() {
  ...
  async function fetchConversations(offset: number, append: boolean) {
    ...
    const allConvos = append ? [...conversations, ...convos] : convos;
    ...
    // Batch fetch last messages for new conversations (avoids N+1)
    if (convos.length > 0) {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      ...
      .on(
        ...
        (payload) => {
          ...
          // Only update if this conversation is in our list
    ...
    // Re-subscribe when conversation list changes
    // eslint-disable-next-line react-hooks/exhaustive-deps
